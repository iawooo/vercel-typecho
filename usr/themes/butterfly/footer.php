...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.loadLocalSearch = function() {
        ...
        var path = (GLOBAL_CONFIG && GLOBAL_CONFIG.localSearch && GLOBAL_CONFIG.localSearch.path) ? 
            GLOBAL_CONFIG.localSearch.path : 'search.php';
    ...
    function setupSearchInput() {
        ...
        input.addEventListener('input', function() {
            ...
            if (count === 0) {
                var emptyText = (GLOBAL_CONFIG && GLOBAL_CONFIG.localSearch && GLOBAL_CONFIG.localSearch.languages && GLOBAL_CONFIG.localSearch.languages.hits_empty) ? 
                    GLOBAL_CONFIG.localSearch.languages.hits_empty : '找不到相关内容：${query}';
