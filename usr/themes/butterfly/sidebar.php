    ...
    <div class="card-widget card-info" data-aos="fade-left" data-aos-easing="ease-out" data-aos-duration="4000"
        ...
        <div class="card-info-avatar is-center">
            <div class="avatar-img">
                <img id="img_hover" data-lazy-src="<?php $this->options->themeUrl('img/archive.png'); ?>"
                    onerror="this.onerror=null;this.src='<?php $this->options->themeUrl('img/archive.png'); ?>'"
        ...
        <div class="card-widget card-webinfo" data-aos="fade-left" data-aos-easing="ease-out" data-aos-duration="4000"
            ...
            <div class="webinfo">
                ...
                function updateVisitorStats() {
                    fetch('<?php $this->options->themeUrl('public/visitorStats.php'); ?>')
                        .then(response => {
                            if (!response.ok) {
                        ...
                        .then(data => {
                            ...
                            if (activeUsersElement) {
                                ...
                                activeUsersElement.style.display = 'inline-block';
                            }
                            
                            if (totalPageviewsElement) {
                                totalPageviewsElement.textContent = data.totalVisits;
                                totalPageviewsElement.style.display = 'inline-block';
                            }
                        })
                        .catch(error => {
                            ...
                            if (totalPageviewsElement) {
                                totalPageviewsElement.textContent = '100';
                                totalPageviewsElement.style.display = 'inline-block';
                            }
                        });
                }
                ...
                // 设置定期更新，每1分钟获取一次新数据
                setInterval(updateVisitorStats, 60000); // 60000毫秒 = 1分钟
                </script>
                ...
                <div class="webinfo-item">
                    ...
                    <div class="item-count">
                        <div id="loadingIconActiveUsers" class="loading-icon"></div>
                        <span id="activeUsersCount" style="display:none;">0</span>
                    </div>
                </div>
                <div class="webinfo-item">
                    ...
                    <div class="item-count">
                        <div id="loadingIconTotalPageviews" class="loading-icon"></div>
                        <span id="totalPageviews" style="display:none;">0</span>
                    </div>
                </div>
                <?php endif; ?>
